...
#
#     PHX_SERVER=true bin/price_spotter start
#
...
config :price_spotter, stage: System.fetch_env!("STAGE")
...
if config_env() == :prod do
  ...
  #
  #     config :price_spotter, PriceSpotter.Mailer,
