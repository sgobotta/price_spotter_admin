defmodule PriceSpotterWeb.CoreComponents do
  @moduledoc """
  ...
  attr :container_class, :string,
    default: "",
    doc: "classes for the div container"
  ...
  def label(assigns) do
    ...
    <label
      for={@for}
      class="block text-sm font-semibold leading-6 text-zinc-700 dark:text-zinc-300"
    >
      <%= render_slot(@inner_block) %>
    </label>
    """
          ...
          >
            ...
            >
              <div class="block py-4 pr-6">
                ...
                <span class={["relative", i == 1 && "font-semibold text-zinc-900"]}>
  ...
  def back(assigns) do
    ...
    <div class="mt-16">
      <.link
        navigate={@navigate}
        class="text-sm font-semibold leading-6 text-zinc-900 hover:text-zinc-700 dark:text-zinc-100 hover:dark:text-zinc-400"
      >
  ...
  def dropdown(assigns) do
    ...
    <div class="relative inline-block text-left">
      ...
      <div
        id={@id}
        class="absolute right-0 z-20 hidden"
        phx-click-away={
          JS.hide(
            to: "##{@id}",
            transition: {"duration-75", "opacity-100", "opacity-0"}
          )
        }
      >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      ...
      Gettext.dgettext(PriceSpotterWeb.Gettext, "errors", msg, opts)
    end
  end
