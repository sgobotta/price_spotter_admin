defmodule PriceSpotterWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("price_spotter.repo.query.total_time",
        unit: {:native, :millisecond},
      ...
      summary("price_spotter.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("price_spotter.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
